...
classic_case_spec <- list(
  ...
  "Athens (democracy)"     = list(polity = c("Athens", "Athenai Attika"),
                                  start = -508, end = -322),
  "Rome (early Republic)" = list(polity = "Roman Republic", 
                                 start = -509, end = -134),
  "Rome (late Republic)"  = list(polity = "Roman Republic", 
                                 start = -133, end =  -27),
  "Roman Empire (Principate)"  = list(polity = "Roman Empire",
                                  start = -27, end = 284),
  "Rome (Dominate)"        = list(polity = "Roman Empire",   
                                  start =  284, end =  476),
  ...
  "Achaemenid Persia"      = list(polity = c("Achaemenid Empire", "Achaemenid Kingdom"),
                                  start = -559, end = -330),
  # ---- 中世紀 -----------------------------------------------------------
  "Venice (pre-Serrata)"   = list(polity = "Venice",
                                  start = 697, end = 1297),
  "Venice (post-Serrata)"   = list(polity = "Venice",
                                  start = 1298, end = 1797),
